...
Describe "Type inference Tests" -tags "CI" {
    ...
    It "Infers typeof Select-Object when Parameter is ExcludeProperty" {
        ...
        $res.Count | Should -Be 1
        $res[0].Name | Should -BeExactly "System.Management.Automation.PSObject#Attributes:BaseName:Directory:DirectoryName:FullName:IsReadOnly:Length:Length:LinkTarget:LinkType:Mode:ModeWithHardLink:Name:Name:Target:VersionInfo"
